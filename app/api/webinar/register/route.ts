  ...
  try {
    ...
    if (process.env.SENDGRID_API_KEY && process.env.SENDGRID_FROM_EMAIL) {
      try {
        ...
        const githubRepoUrl = process.env.GITHUB_REPO_URL || 'https://github.com/your-org/ai-validation-toolkit'
        const methodologyReportUrl = `${baseUrl}/VALIDATION_METHODOLOGY_REPORT.md`
          ...
          html: `
            ...
            <body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Arial, sans-serif; line-height: 1.6; color: #334e68; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #f0f4f8;">
              <div style="background: white; border-radius: 8px; padding: 30px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
                ...
                <div style="background: #f0f4f8; border-left: 4px solid #486581; padding: 20px; margin: 25px 0; border-radius: 4px;">
                  ...
                  <div style="margin: 20px 0;">
                    ...
                    <a href="${githubRepoUrl}" style="display: inline-block; background: #486581; color: white; padding: 12px 24px; text-decoration: none; border-radius: 6px; font-weight: 600; margin-top: 8px;">Access GitHub Repository →</a>
                  </div>
                  ...
                  <div style="margin: 20px 0;">
                    ...
                    <a href="${methodologyReportUrl}" style="display: inline-block; background: #486581; color: white; padding: 12px 24px; text-decoration: none; border-radius: 6px; font-weight: 600; margin-top: 8px;">Read Methodology Report →</a>
                  </div>
              ...
              <div style="text-align: center; margin-top: 20px; color: #9fb3c8; font-size: 12px;">
                ...
                <p><a href="${baseUrl}/webinar" style="color: #486581;">View Landing Page</a> | <a href="#" style="color: #486581;">Unsubscribe</a></p>
              </div>
            </body>
            </html>
          `,
